...
#include "FBL/TP2/E04_TP2_FBL.h"

// Sets default values
AE04_TP2_FBL::AE04_TP2_FBL()
{
...
void AE04_TP2_FBL::BeginPlay()
{
	...
	MostrarMensaje(
		FString::Printf(TEXT("Valor de ataque final: %d"),ValorDeAtaqueFinal),
		FColor::White
	);
...
int32 AE04_TP2_FBL::CalcularAtaque(int32 CantidadDePoder)
{
	return (CantidadDePoder*5)+10;
}

void AE04_TP2_FBL::MostrarMensaje(const FString& Mensaje,FColor Color)
{
	if (GEngine)
	{
